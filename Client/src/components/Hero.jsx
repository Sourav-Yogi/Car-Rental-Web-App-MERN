...
const Hero = () => {
  ...
  return (
    ...
    className="h-screen flex flex-col items-center justify-center gap-14 bg-light text-center">
      ...
      <motion.form 
        initial={{scale:0.95, opacity:0, y:50}} animate={{scale:1,opacity:1,y:0}} transition={{duration: 0.6,delay:0.4}}
        ...
        <div className="flex flex-col md:flex-row items-start md:items-center gap-10 md:ml-8">
          <div className="flex flex-col items-start gap-2">
            ...
            <p className="px-1 text-sm text-gray-500">
              {!pickupLocation ? "Please select location" : pickupLocation}
            </p>
          </div>
        </div>
      ...
      <motion.img
      initial={{ opacity:0, y:100}} animate={{opacity:1,y:0}} transition={{duration: 0.8,delay:0.6}}
